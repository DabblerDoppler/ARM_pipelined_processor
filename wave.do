...
add wave -noupdate /cpu_testbench/dut/instruction_temp
...
add wave -noupdate /cpu_testbench/dut/data_memory/mem
...
add wave -noupdate /cpu_testbench/dut/forward_rd_mem_to_a
add wave -noupdate /cpu_testbench/dut/forward_rd_wb_to_a
add wave -noupdate /cpu_testbench/dut/wb_reg_write
add wave -noupdate /cpu_testbench/dut/eq_rn_mem
add wave -noupdate /cpu_testbench/dut/forward_rd_mem_to_b
add wave -noupdate /cpu_testbench/dut/forward_a
add wave -noupdate -radix decimal /cpu_testbench/dut/forwarding_choice_a
add wave -noupdate /cpu_testbench/dut/mem_wb_forward_a
add wave -noupdate /cpu_testbench/dut/eq_rn_ex
add wave -noupdate /cpu_testbench/dut/mem_reg_write
add wave -noupdate /cpu_testbench/dut/rf_rn_can_write
add wave -noupdate /cpu_testbench/dut/forward_rd_exec_to_a
add wave -noupdate /cpu_testbench/dut/eq_rn_rf
add wave -noupdate /cpu_testbench/dut/ex_reg_write
add wave -noupdate -radix unsigned /cpu_testbench/dut/rf_rn_addr
add wave -noupdate -radix decimal /cpu_testbench/dut/write_to_register
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {12490003 ps} 0}
...
update
WaveRestoreZoom {5625150 ps} {24375652 ps}
